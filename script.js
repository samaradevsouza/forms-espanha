    ...
    if (formSelecionado === "formSp") {
        ...
        arquivos.push({
            ...
            campos: {
                ...
                'Progenitor1ProgB': dadosDDN.maeMae,
                'Progenitor2ProgB': dadosDDN.paiMae,
        ...
        },
            {
                ...
                nome: 'solicitud.pdf',
                campos: {
                    'text_89pfgn': dados.nomeReq,
                    'text_91rghe': dadosDDN.dataNasc,
                    'text_100ufpa': dadosDDN.localidad + ", " + dadosDDN.paisNasc,
                    'textarea_92zjnr': dadosDDN.nomeCompletoMae + " y " + dadosDDN.nomeCompletoPai,
                    'textarea_101jypq': dados.sexo,
                    'textarea_102bres' : dados.estadoCivilReq,
                    'textarea_93cclu': dados.endReq + ", " + dados.estadoReq + ", " + dados.paisReq + ", CEP: " + dados.cepReq,
                    'textarea_94ygrg': dados.telReq,
                    'textarea_103nijm': dados.emailReq,
                    'text_104ecdu': dadosDDN.conjugeReq,
